  ...
  const faqs = [
    {
      ...
      answer:
        "AirStore provides unique, customizable components designed to simplify the development process and enhance user experience.",
    },
    {
      id: 3,
      question: "Q. Do you provide any moneyback guarantee for this product?",
      answer:
        "Yes, we offer a 30-day money-back guarantee if you are not satisfied with AirStore.",
    },
    {
      id: 4,
      question: "Q. What payment method do you support?",
      answer:
        "AuraUI supports various payment methods including credit cards and PayPal.",
    },
    {
      id: 5,
          ...
          <div className="px-6 py-12 sm:p-12">
            <div className="max-w-sm mx-auto">
              ...
              <div className="mt-6">
                <Link
                  href="sign-up"
                  className="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white transition-all duration-200 bg-gray-600 border border-transparent rounded-full hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black"
                  role="button"
                >
                  Start free trial
                </Link>
